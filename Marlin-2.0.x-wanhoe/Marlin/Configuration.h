...
#define STRING_CONFIG_H_AUTHOR "(EL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "WANHOE"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Wanhao Duplicator i3
  #define  DEFAULT_bedKp 73.65
  #define  DEFAULT_bedKi 12.84
  #define  DEFAULT_bedKd 281.55
  
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
  //#define DEFAULT_bedKp 97.1
  //#define DEFAULT_bedKi 1.41Nn
...
//
// Note: Usually sold with a white PCB.C
//
