...
#define STRING_CONFIG_H_AUTHOR "(Modix, EL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Modix 120X"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 17.5 // If the temperature difference between the target temperature and the actual temperature
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 199.8, 100.2, 2000, 418.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 22, -1.60 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 522  // Y point for Z homing
#endif
