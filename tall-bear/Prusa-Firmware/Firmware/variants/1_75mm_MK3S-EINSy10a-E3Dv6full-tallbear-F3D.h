...
#define TEMP_RUNAWAY_EXTRUDER_HYSTERESIS 20
#define TEMP_RUNAWAY_EXTRUDER_TIMEOUT 60
...
#define PC_PREHEAT_HOTEND_TEMP 300
#define PC_PREHEAT_HPB_TEMP 85
